...
namespace MonoDevelop {
    ...
    public partial class GendarmeDisplay {
        ...
        protected virtual void Build() {
            ...
            Gtk.Box.BoxChild w4 = ((Gtk.Box.BoxChild)(this.hbox2[this.lblVio]));
            w4.Position = 1;
            w4.Expand = false;
            w4.Fill = false;
            this.statusbar1.Add(this.hbox2);
            Gtk.Box.BoxChild w5 = ((Gtk.Box.BoxChild)(this.statusbar1[this.hbox2]));
            w5.Position = 1;
            w5.Expand = false;
            w5.Fill = false;
            // Container child statusbar1.Gtk.Box+BoxChild
            ...
            Gtk.Box.BoxChild w7 = ((Gtk.Box.BoxChild)(this.hbox3[this.lblRules]));
            w7.Position = 1;
            w7.Expand = false;
            w7.Fill = false;
            this.statusbar1.Add(this.hbox3);
            Gtk.Box.BoxChild w8 = ((Gtk.Box.BoxChild)(this.statusbar1[this.hbox3]));
            w8.Position = 2;
            w8.Expand = false;
            w8.Fill = false;
            this.vbox3.Add(this.statusbar1);
            Gtk.Box.BoxChild w9 = ((Gtk.Box.BoxChild)(this.vbox3[this.statusbar1]));
            w9.Position = 1;
            w9.Expand = false;
            w9.Fill = false;
            this.Add(this.vbox3);
